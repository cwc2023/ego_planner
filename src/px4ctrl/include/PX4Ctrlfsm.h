...
private:
    ...
    // ---- auto takeoff/land ----
    void motors_idling(const Imu_Data_t &imu, Controller_Output_t &u); //让无人机的电机处于怠速状态 
    void land_detector(const State_t state, const Desired_State_t &des, const Odom_Data_t &odom); // 检验无人机是否处于着陆状态
