...
if("TRUE" STREQUAL "TRUE")
  set(poscmd_2_odom_SOURCE_PREFIX /home/cwc/ego_planner/src/ego-planner-swarm/src/uav_simulator/fake_drone)
  set(poscmd_2_odom_DEVEL_PREFIX /home/cwc/ego_planner/devel)
  ...
  set(poscmd_2_odom_INSTALL_PREFIX /home/cwc/ego_planner/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'poscmd_2_odom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cwc/ego_planner/src/ego-planner-swarm/src/uav_simulator/fake_drone/${idir}'.  ${_report}")
    endif()
