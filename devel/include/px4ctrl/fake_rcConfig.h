...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.size = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(fake_rcConfig::AbstractParamDescriptionConstPtr(new fake_rcConfig::ParamDescription<int>("size", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'Small', 'type': 'int', 'value': 0, 'srcline': 13, 'srcfile': '/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg', 'description': 'A small constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Medium', 'type': 'int', 'value': 1, 'srcline': 14, 'srcfile': '/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg', 'description': 'A medium constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Large', 'type': 'int', 'value': 2, 'srcline': 15, 'srcfile': '/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg', 'description': 'A large constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ExtraLarge', 'type': 'int', 'value': 3, 'srcline': 16, 'srcfile': '/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg', 'description': 'An extra large constant', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &fake_rcConfig::size)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(fake_rcConfig::AbstractParamDescriptionConstPtr(new fake_rcConfig::ParamDescription<int>("size", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'Small', 'type': 'int', 'value': 0, 'srcline': 13, 'srcfile': '/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg', 'description': 'A small constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Medium', 'type': 'int', 'value': 1, 'srcline': 14, 'srcfile': '/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg', 'description': 'A medium constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Large', 'type': 'int', 'value': 2, 'srcline': 15, 'srcfile': '/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg', 'description': 'A large constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ExtraLarge', 'type': 'int', 'value': 3, 'srcline': 16, 'srcfile': '/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg', 'description': 'An extra large constant', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &fake_rcConfig::size)));
...
//#line 13 "/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg"
      const int fake_rc_Small = 0;
//#line 14 "/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg"
      const int fake_rc_Medium = 1;
//#line 15 "/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg"
      const int fake_rc_Large = 2;
//#line 16 "/home/cwc/ego_planner/src/px4ctrl/cfg/fake_rc.cfg"
